...
public class EventoAdapterAsistidos extends FirebaseRecyclerAdapter<MockEvent, EventoAdapterAsistidos.EventoViewHolder> {
    ...
    public EventoAdapterAsistidos(@NonNull FirebaseRecyclerOptions<MockEvent> options, List<Long> ids) {
        super(options);
        this.ids = ids;
    }
